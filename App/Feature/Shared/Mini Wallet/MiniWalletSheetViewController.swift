...
class MiniWalletSheetViewController: UIViewController {
    ...
    var tableHeaderText: String? = Configuration.shared.opco.isPHI ? NSLocalizedString("We accept: VISA, MasterCard, Discover and American Express Credit Cards or Check Cards.", comment: "") : NSLocalizedString("We accept: Amex, Discover, MasterCard, Visa Credit Cards or Check Cards, and ATM Debit Cards with a PULSE, STAR, NYCE, or ACCEL logo.", comment: "") // Set to override if necessary
    ...
    private func style() {
        ...
        tableHeaderLabel.font = .caption1
    }
