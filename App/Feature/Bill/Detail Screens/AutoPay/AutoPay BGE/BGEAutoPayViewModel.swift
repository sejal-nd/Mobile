...
class BGEAutoPayViewModel {
    ...
    var learnMoreDescriptionText: String {
        if accountDetail.isResidential {
            return Environment.shared.opco.isPHI ? NSLocalizedString("""
            ...
            AutoPay will charge the amount billed each month or the maximum amount specified, up to a limit of $300,000, if applicable. You will receive a notification after your new bill is generated and an upcoming automatic payment is created. Upcoming automatic payments may be viewed or cancelled on the Bill & Payment Activity page. Submitting other payments may result in overpaying and a credit being applied to your account. Please ensure you have adequate funds in your bank account to cover the AutoPay deduction.
