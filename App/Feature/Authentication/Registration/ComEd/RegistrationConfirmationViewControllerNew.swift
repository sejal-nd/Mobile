...
class RegistrationConfirmationViewControllerNew: DismissableFormSheetViewController {
    ...
    override func viewDidLoad() {
        ...
        let secondaryString = "\n\nCheck your spam/junk mail folder or send the verification email again."
