//
//  MoveFinalMailingAddressViewController.swift
//  EUMobile
//
...
import RxCocoa
import RxSwift
protocol MoveFinalMailingAddressDelegate {
    func mailingAddress(_ address: MailingAddress)
}


class MoveFinalMailingAddressViewController: KeyboardAvoidingStickyFooterViewController {
    ...
    private var viewModel: MoveFinalMailingAddressViewModel!
    var isLaunchedFromReviewScreen: Bool = false
    var moveFlowData: MoveServiceFlowData!
    var delegate: MoveFinalMailingAddressDelegate? = nil
    ...
    func refreshData() {
        ...
        viewModel.setMailingData(moveFlowData)
...
extension MoveFinalMailingAddressViewController: UITextFieldDelegate {
