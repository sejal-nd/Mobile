...
public enum Router {
    ...
    case fetchB2CoPowerJWT(request: B2CoPowerJWTRequest) // oPower Widgets
    ...
    public var apiAccess: ApiAccess {
        switch self {
        case .weather, .fetchB2CToken, .refreshB2CToken, .fetchB2CJWT, .fetchB2CoPowerJWT:
            return .none
