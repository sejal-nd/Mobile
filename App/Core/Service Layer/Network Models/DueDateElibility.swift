...
public struct DueDateElibility: Decodable {
    ...
    let collectionArrangementStatus: String?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case collectionArrangementStatus = "collectionArrangementStatus"
    ...
    public init(from decoder: Decoder) throws {
        ...
        collectionArrangementStatus = (try container.decodeIfPresent(String.self, forKey: .collectionArrangementStatus))
