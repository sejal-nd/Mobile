...
enum StatusInfoMessage: Int {
    ...
    var details: String {
        switch self {
            case .etrToolTip:
                return "At BGE we strive to give our customers the most up to date ETRs available. The Outage Tracker is refreshed every two minutes to provide you with our team’s most recent estimate.\n\nETRs are first based on restoration repair history or data from previous storms. After that, the most accurate estimates come from our field crews."
            case .hazardMessage:
