...
class BillViewModel {
    ...
    private(set) lazy var shouldShowCatchUpDisclaimer: Driver<Bool> = Driver.zip(currentAccountDetail, shouldShowCatchUpAmount)
...
//        if $0.billingInfo.pendingPayments.last?.amount == $0.billingInfo.netDueAmount {
