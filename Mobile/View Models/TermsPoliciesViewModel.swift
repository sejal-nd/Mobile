...
class TermsPoliciesViewModel {
    ...
    var agreeLabelText: String {
        get {
            return String(format: NSLocalizedString("I agree to %@'s Terms and Policies", comment: ""), Environment.sharedInstance.opco)
        }
    }
    ...
    var attributedTermsString: NSAttributedString {
        get {
            ...
            attrString.addAttribute(NSFontAttributeName, value: UIFont(name: "OpenSans", size: 16)!, range: range)
