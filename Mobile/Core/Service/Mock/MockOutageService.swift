...
class MockOutageService: OutageService {
    ...
    private func getOutageStatus(accountNumber: String) -> OutageStatus {
        ...
        let april102018 = Calendar.opCo.date(from: DateComponents(year: 2017, month: 4, day: 10, hour: 3, minute: 45))
        let opCoGMTOffset = abs(Int(TimeZone.opCo.secondsFromGMT(for: april102018!)) / 3600)
