...
class MCSPeakRewardsService: PeakRewardsService {
    ...
    func fetchPeakRewardsSummary(accountNumber: String, premiseNumber: String) -> Observable<PeakRewardsSummary> {
        return MCSApi.shared.get(path: "accounts/\(accountNumber)/premises/\(premiseNumber)/peak")
            .map { json in
    ...
    func fetchPeakRewardsOverrides(accountNumber: String, premiseNumber: String) -> Observable<[PeakRewardsOverride]> {
        return MCSApi.shared.get(path: "accounts/\(accountNumber)/premises/\(premiseNumber)/peak/override")
            .map { json in
    ...
    func scheduleOverride(accountNumber: String,
        ...
        return MCSApi.shared.post(path: "accounts/\(accountNumber)/premises/\(premiseNumber)/peak/devices/\(device.serialNumber)/override",
    ...
    func deleteOverride(accountNumber: String,
        ...
        return MCSApi.shared.delete(path: "accounts/\(accountNumber)/premises/\(premiseNumber)/peak/devices/\(device.serialNumber)/override", params: nil)
            .mapTo(())
    }
    ...
    func fetchDeviceSettings(accountNumber: String,
        ...
        return MCSApi.shared.get(path: "accounts/\(accountNumber)/premises/\(premiseNumber)/peak/devices/\(device.serialNumber)/settings")
            .map { json in
                guard let dict = json as? NSDictionary,
    ...
    func updateDeviceSettings(forDevice device: SmartThermostatDevice,
        ...
        return MCSApi.shared.post(path: "accounts/\(accountNumber)/premises/\(premiseNumber)/peak/devices/\(device.serialNumber)/settings",
    ...
    func fetchSmartThermostatSchedule(forDevice device: SmartThermostatDevice,
        ...
        return MCSApi.shared.get(path: "accounts/\(accountNumber)/premises/\(premiseNumber)/peak/devices/\(device.serialNumber)/schedule")
            .map { json in
                guard let dict = json as? NSDictionary,
    ...
    func updateSmartThermostatSchedule(forDevice device: SmartThermostatDevice,
        ...
        return MCSApi.shared.post(path: "accounts/\(accountNumber)/premises/\(premiseNumber)/peak/devices/\(device.serialNumber)/schedule",
