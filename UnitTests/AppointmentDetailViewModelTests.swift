...
class AppointmentDetailViewModelTests: XCTestCase {
    ...
    let viewModel = AppointmentDetailViewModel(appointment: Appointment(id: "0", startDate: Date(), stopDate: Date(), status: .scheduled, caseNumber: "0")) // Don't worry about this appointment, we'll override in every test
    let disposeBag = DisposeBag()
    
    func testTabTitle() {
        let st = Calendar.opCo.date(from: DateComponents(year: 2018, month: 10, day: 31))!
        viewModel.appointment = Appointment(id: "0", startDate: st, stopDate: Date(), status: .scheduled, caseNumber: "0")
        XCTAssertEqual(viewModel.tabTitle, "Oct 31st")
        
        let nd = Calendar.opCo.date(from: DateComponents(year: 2018, month: 8, day: 2))!
        viewModel.appointment = Appointment(id: "0", startDate: nd, stopDate: Date(), status: .scheduled, caseNumber: "0")
        XCTAssertEqual(viewModel.tabTitle, "Aug 2nd")
        
        let rd = Calendar.opCo.date(from: DateComponents(year: 2018, month: 1, day: 3))!
        viewModel.appointment = Appointment(id: "0", startDate: rd, stopDate: Date(), status: .scheduled, caseNumber: "0")
        XCTAssertEqual(viewModel.tabTitle, "Jan 3rd")
        
        let th = Calendar.opCo.date(from: DateComponents(year: 2018, month: 3, day: 4))!
        viewModel.appointment = Appointment(id: "0", startDate: th, stopDate: Date(), status: .scheduled, caseNumber: "0")
        XCTAssertEqual(viewModel.tabTitle, "Mar 4th")
    }
    
    func testCaseNumberText() {
        viewModel.appointment = Appointment(id: "0", startDate: Date(), stopDate: Date(), status: .scheduled, caseNumber: "813")
        XCTAssertEqual(viewModel.caseNumberText, NSLocalizedString("Case #813", comment: ""))
    }
    
    func testShowProgressView() {
        viewModel.appointment = Appointment(id: "0", startDate: Date(), stopDate: Date(), status: .scheduled, caseNumber: "0")
        XCTAssertTrue(viewModel.showProgressView)
        
        viewModel.appointment = Appointment(id: "0", startDate: Date(), stopDate: Date(), status: .enRoute, caseNumber: "0")
        XCTAssertTrue(viewModel.showProgressView)
        
        viewModel.appointment = Appointment(id: "0", startDate: Date(), stopDate: Date(), status: .inProgress, caseNumber: "0")
        XCTAssertTrue(viewModel.showProgressView)
        
        viewModel.appointment = Appointment(id: "0", startDate: Date(), stopDate: Date(), status: .complete, caseNumber: "0")
        XCTAssertTrue(viewModel.showProgressView)
        
        viewModel.appointment = Appointment(id: "0", startDate: Date(), stopDate: Date(), status: .canceled, caseNumber: "0")
    ...
    func testAppointmentDescriptionText() {
        ...
        viewModel.appointment = Appointment(id: "0", startDate: today2, stopDate: today3, status: .scheduled, caseNumber: "0")
        ...
        viewModel.appointment = Appointment(id: "0", startDate: tomorrow230, stopDate: tomorrow330, status: .scheduled, caseNumber: "0")
        ...
        viewModel.appointment = Appointment(id: "0", startDate: future9, stopDate: future11, status: .scheduled, caseNumber: "0")
        ...
        // In Progress
        viewModel.appointment = Appointment(id: "0", startDate: Date(), stopDate: today3, status: .inProgress, caseNumber: "0")
    ...
    func testCalendarEvent() {
        ...
        let today2 = Calendar.opCo.date(bySettingHour: 14, minute: 0, second: 0, of: Date())!
        let today3 = Calendar.opCo.date(bySettingHour: 15, minute: 0, second: 0, of: Date())!
        viewModel.appointment = Appointment(id: "0", startDate: today2, stopDate: today3, status: .scheduled, caseNumber: "813")
