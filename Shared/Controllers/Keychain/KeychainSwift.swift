...
open class KeychainController {
  ...
  */
  @discardableResult
    open func set(_ value: String, forKey key: KeychainController.Key,
  ...
  */
  @discardableResult
  open func set(_ value: Data, forKey key: KeychainController.Key,
    withAccess access: KeychainSwiftAccessOptions? = nil) -> Bool {
  ...
  */
  @discardableResult
  open func set(_ value: Bool, forKey key: KeychainController.Key,
    withAccess access: KeychainSwiftAccessOptions? = nil) -> Bool {
  ...
  */
  open func get(_ key: KeychainController.Key) -> String? {
  ...
  */
  open func getData(_ key: KeychainController.Key, asReference: Bool = false) -> Data? {
    // The lock prevents the code to be run simultaneously
    // from multiple threads which may result in crashing
    lock.lock()
    defer { lock.unlock() }
  ...
  */
  open func getBool(_ key: KeychainController.Key) -> Bool? {
  ...
  */
  @discardableResult
  open func delete(_ key: KeychainController.Key) -> Bool {
    // The lock prevents the code to be run simultaneously
    // from multiple threads which may result in crashing
    lock.lock()
    defer { lock.unlock() }
  ...
  */
   ...
   */
  @discardableResult
  func deleteNoLock(_ key: KeychainController.Key) -> Bool {
    let prefixedKey = keyWithPrefix(key)
  ...
  */
  ...
  func keyWithPrefix(_ key: KeychainController.Key) -> String {
